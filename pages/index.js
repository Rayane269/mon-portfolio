...
import DisciplineCards from "@layouts/components/DisciplineCards";
          ...
          <div className="row flex-wrap-reverse items-center justify-center lg:flex-row">
            <div className={banner.image_enable ? "mt-12 text-center lg:mt-0 lg:text-left lg:col-6" : "mt-12 text-center lg:mt-0 lg:text-left lg:col-12"}>
              <div className="banner-title">
                {markdownify(banner.title, "span")}
                {markdownify(banner.title_small, "h1")}
              </div>
            ...
            <div className="mb-12 ">
              ...
              {featured_posts.enable && (
                <div className="section">
                  ...
                  <div className="rounded border border-border  dark:border-darkmode-border">
